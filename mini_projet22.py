...
class GABApplication:
    ...
    def infos(self, password, nom, prenom, solde):
        ...
        Label(fenetre_informations, text="Nom:", width=15, font=("Georgia", 10, "bold", "italic"), bd=5,
              relief="groove", background="#D2B48C").grid(row=1, column=0, padx=10, pady=10)
        Label(fenetre_informations, text=nom, width=15, font=("Georgia", 10, "bold", "italic"), bd=5,
              relief="groove", background="#D2B48C").grid(row=1, column=1, padx=10, pady=10)
        Label(fenetre_informations, text="Prenom:", width=15, font=("Georgia", 10, "bold", "italic"), bd=5,
              relief="groove", background="#D2B48C").grid(row=2, column=0, padx=10, pady=10)
        Label(fenetre_informations, text=prenom, width=15, font=("Georgia", 10, "bold", "italic"), bd=5,
              relief="groove", background="#D2B48C").grid(row=2, column=1, padx=10, pady=10)
    ...
    def afficher_solde(self, solde):
        ...
        Label(fenetre_solde, text=f"Votre solde est de :{solde} Dhs.", bg="#D2B48C").place(x=50, y=80)

 


if __name__ == '__main__':
    gab_app = GABApplication()
    gab_app.run()
